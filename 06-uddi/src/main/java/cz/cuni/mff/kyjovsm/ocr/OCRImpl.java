...
@UDDIService(
        businessKey="ocr",
        serviceKey="uddi:${keyDomain}:services-ocr${department}",
        description = "OCR test service")
@UDDIServiceBinding(
        bindingKey="uddi:${keyDomain}:${serverName}-${serverPort}-ocr${department}-wsdl",
        description="WSDL endpoint for the ${department} Service. This service is used for "
                + "testing the jUDDI annotation functionality",
        accessPointType="wsdlDeployment",
        accessPoint="http://${serverName}:${serverPort}/uddi-annotations/services/ocr?wsdl")
@WebService(endpointInterface = "cz.cuni.mff.kyjovsm.ocr.OCR", serviceName = "OCR")
